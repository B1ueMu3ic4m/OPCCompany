...
$logic = @(
  'Models.swift','CompanyStore.swift','CompanyPersistence.swift','KeychainStore.swift','ObservationCompat.swift','AgentMessageDisplay.swift','StringExtras.swift','DPAPISecretStore.swift','OPCWriteGuard.swift','OPCBridge.swift',
